from datasource.totto.preprocessing.lattice.preprocess_utils import get_highlighted_subtable


def linearize_table_with_index(table, cell_indices, table_page_title, table_section_title, order_cell=False,
                               highlight_cells: bool = False, full_table: bool = True):
    """
    ...
    * highlighted cells (<cell>)
    ...
    for item in subtable:
        ...
        if highlight_cells and full_table and [r_index, c_index] in cell_indices:
        ...
        item_str = start_cell_marker + cell["value"] + " "
    ...
    if cell_indices and highlight_cells and full_table:
