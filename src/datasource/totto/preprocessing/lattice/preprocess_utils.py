...
def get_highlighted_subtable(table, cell_indices, with_heuristic_headers=False, full_table:bool = False):
    ...
    if full_table:
        cell_indices = [[r, c] for r, row in enumerate(table) for c in range(len(row))]
